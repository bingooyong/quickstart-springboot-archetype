...
import ${package}.exceptions.BaseException;
import ${package}.exceptions.BaseBizException;
...
public class GloableExceptionHandler {
    ...
    public ReturnResult handleException(Exception ex, WebRequest request) {
        ...
        if (ex instanceof BaseException) {
            ...
            return getResponseEntityOfBizEx((BaseBizException) ex, request);
     ...
     * @return
     */
    private ReturnResult getResponseEntityOfBizEx(BaseBizException ex, WebRequest request) {
